			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb" style="background-color: #323741">
						...
						<li><a style="text-align:center;color:#fcc39b">Contact</a></li>
					</ul>
				</div>
			</div>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="heading">
					<h2 class="text-center" style="padding-top:30px; margin:0; color:#f3906c" >Contact Us</h2>
				</div>
				<hr>
			</div>
			<div class="col-md-6" style="padding-top: 10px; margin-left: 25%">
